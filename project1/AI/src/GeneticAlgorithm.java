...
public class GeneticAlgorithm {
    ...
    public static int maxFitnessScore;
    ...
    public static void geneticAlgorithm(char[][] m){
        ...
        System.out.println("max fitness: " + maxFitnessScore);
    ...
    public static void tournamentSelection(ArrayList<char[][]> population){
        ...
        char[][] winner;
        int numOfBrackets = 10000; //what proportion of the population will be in each bracket (1/10)
